...
namespace Voucher
{
    public class Voucher_first
    {
        ...
        // Конструктори
        public Voucher_first()
        {

        }
        public Voucher_first(int id, string country)
        {
            this.id = id;
            this.country = country;
            this.servicing = "Bussines";
        }
        public Voucher_first(string country, int period)
        {
            this.id = id;
            this.country = country;
            this.period = period;
        ...
        public Voucher_first(string country, int period, string servicicng)
        {
            this.id = id;
            this.country = country;
            this.period = period;
        ...
        public Voucher_first(int id, string country, int period, string servicicng, int cost)
        {
            this.id = id;
            this.country = country;
            this.period = period;
        ...
        public virtual void show_voucher()
        {
        ...
        public static void search_by_id(Voucher_first[] vouchers, int id)
        {
            bool found = false;
        ...
        public static void search_by_country(Voucher_first[] vouchers, string country)
        {
            bool found = false;
            for (int i = 0; i < vouchers.Length; i++)
            {
        ...
        public static void search_by_servicing(Voucher_first[] vouchers, string servicing)
        {
            bool found = false;
            for (int i = 0; i < vouchers.Length; i++)
            {
        ...
        public static void search_by_cost(Voucher_first[] vouchers, int cost)
        {
            bool found = false;
            for (int i = 0; i < vouchers.Length; i++)
            {
        ...
        public static void search_by_period(Voucher_first[] vouchers, int period)
        {
            bool found = false;
            for (int i = 0; i < vouchers.Length; i++)
            {
        ...
        public static bool operator ==(Voucher_first first, Voucher_first second)
        {
